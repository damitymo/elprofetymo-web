...
export default function SobreMiPage() {
  return (
    <>
      ...
      {/* GITHUB PROFILE (sync automático) */}
      <section className="container-narrow py-12 max-w-3xl">
        <h2 className="text-2xl font-medium mb-2">Desde GitHub, en vivo</h2>
        <p className="text-white/60 mb-6 text-sm">
          Lo que estoy escribiendo últimamente, traído directo del perfil.
        </p>
        <GithubProfile />
      </section>
